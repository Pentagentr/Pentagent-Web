...
rag_pent_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Rag-Pent')
...
async def run_comprehensive_test():
    ...
    config_obj = SearchConfig(
        ...
        qdrant_host="ca7c82ea-1098-402b-a2d8-6c8ecf74b93d.europe-west3-0.gcp.cloud.qdrant.io",
        qdrant_port=6333,
        qdrant_api_key="iM-z0e_4bNbfO0M-9Xl5DM5LwL80q0OTv2UX5S7Q18XyvAVJQVQNEg",
        qdrant_https=True
    )
